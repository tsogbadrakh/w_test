...
<?php } ?>
                    ...
                    <tr class="bg">
                        <td><?php echo ((isset($this->_rootref['L_004'])) ? $this->_rootref['L_004'] : ((isset($MSG['004'])) ? $MSG['004'] : '{ L_004 }')); ?> *</td>
                    ...
                    <input type="hidden" name="idhidden" value="<?php echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>">
