...
// version check
$realversion = file_get_contents('http://www.webidsupport.com/version.txt'); //echo "RV: $realversion";
// version check
/*
...
$template->assign_vars(array(
		...
		'GALLERY' => ($system->SETTINGS['picturesgallery'] == 1) ? '<b>' . $MGS_2__0066 . '</b><br>' . $MSG['666'] . ': ' . $system->SETTINGS['maxpictures'] . '<br>' . $MSG['671'] . ': ' . $system->SETTINGS['maxuploadsize'] : '<b>' . $MGS_2__0067 . '</b>',
