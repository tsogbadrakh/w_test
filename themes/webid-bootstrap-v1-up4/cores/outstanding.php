...
$template->assign_vars(array(
		...
		'PREV' => ($PAGES > 1 && $PAGE > 1) ? '<li><a href="' . $system->SETTINGS['siteurl'] . 'outstanding.php?PAGE=' . $PREV . '">' . $MSG['5119'] . '</a></li>' : '',
		'NEXT' => ($PAGE < $PAGES) ? '<li><a href="' . $system->SETTINGS['siteurl'] . 'outstanding.php?PAGE=' . $NEXT . '">' . $MSG['5120'] . '</a></li>' : '',
		'PAGE' => $PAGE,
		'PAGES' => $PAGES
		));
