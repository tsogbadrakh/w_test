<div class="content">
  <div class="tableContent2">
    <div class="titTable2 rounded-top rounded-bottom"> {L_5030} </div>
    <div class="titTable3"> <a href="{SITEURL}boards.php">{L_5058}</a> </div>
    <div class="padding center" align="center">
      ...
      <table width="70%" cellspacing="0" cellpadding="2">
        ...
        <!-- BEGIN msgs -->
        <tr>
          <td align="left" valign="top" width="100%" {msgs.BGCOLOUR}> {msgs.MSG} </td>
          <td valign="top" align="right" bgcolor="#eeeeee" nowrap="nowrap"><!-- IF msgs.USERNAME ne '' -->
